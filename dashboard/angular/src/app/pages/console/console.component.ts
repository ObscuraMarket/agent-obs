...
const COMMAND_HELP: CommandHelp[] = [
  ...
  { cmd: 'withdraw', what: 'Send ETH from your agent\'s wallet back to yours, or a token it holds: /withdraw LENNY', usage: '/withdraw all', args: true },
  { cmd: 'sell', what: 'Sell a token your agent holds for ETH, all of it', usage: '/sell LENNY', args: true },
