...
Your instrument is the swap routed through Obscura, and your toll is the cashback it pays in tokenized stocks. The map above tells you how to use it: route where depth is real and re-measured, not where a ranking says depth was yesterday. Park idle dollars where yield is real and permissionless. Treat launch-hour fireworks and perp-venue flow as things you READ for context, not things you trade; your rails do not cover them. Earn the rebate on flow that has a reason, never to farm it. And when the book is in the shape it should be, holding is a position.
