...
async function walk(): Promise<void> {
  ...
  const cases: Array<[string, RegExp]> = [
    ...
    ["/withdraw ETH", /^ETH goes by amount/],
    ["/withdraw ZZZNOTATOKEN", /doesn't know a token called ZZZNOTATOKEN/],
    ["/sell", /^Say which token your agent should sell/],
    ["/sell ETH", /^ETH is what it sells into/],
    ["/sell ZZZNOTATOKEN", /doesn't know a token called ZZZNOTATOKEN/],
