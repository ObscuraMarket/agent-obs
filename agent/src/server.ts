...
import { walletsOn, agentWalletAddress, rememberWallet, fundTx, withdrawEth, withdrawToken, sellToken, agentBalanceEth, verifyFunding, walletLines, walletBook, readAgentCapital } from "./desk/agentWallet.ts";
